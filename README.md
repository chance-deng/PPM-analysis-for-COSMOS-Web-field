...
We use a sample of 449 SMGs from the $A^3COSMOS$ catalog and control samples of main-sequence star-forming galaxies (SFGs) from COSMOS2025 in the COSMOS-Web JWST field, we apply the Poisson Probability Method (PPM) to identify overdensity structures. We upload here the results of PPM analysis performed on all samples (based on COSMOS2025 and $A^3COSMOS$). For detailed explanations of these parameters, please refer to the paper: XXX

Details for PPM: [Castignani+2014](https://iopscience.iop.org/article/10.1088/0004-637X/792/2/113).
